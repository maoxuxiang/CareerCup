 ...
 * has sufficient space at the terminal of the string to hold the additional characters, and that you
...
//		char[] ss = new char[newLength];
		s[newLength] = '\0'; // '\0' is used to mark the terminal of the characters
